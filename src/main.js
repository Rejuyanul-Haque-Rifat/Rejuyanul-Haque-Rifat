...
const fullPageContent = `
    <main class="min-h-screen pt-32 pb-20 px-6 flex items-center relative" id="home">
    ...
    <section id="about" class="py-24 px-6 relative z-10">
        ...
        <section id="achievements" class="py-24 px-6 relative z-10 border-t border-b border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50">
...
const layout = `
  <div class="min-h-screen flex flex-col bg-lightBase text-slate-800 dark:bg-darkBase dark:text-slate-100 antialiased selection:bg-electric selection:text-white font-sans">
    ...
    <nav class="fixed top-0 w-full z-50 px-6 py-4 transition-all duration-300" id="navbar">
        <div class="max-w-7xl mx-auto neo-glass rounded-full px-6 py-3 flex justify-between items-center relative">
            ...
            <div id="navLinks" class="hidden absolute top-full left-0 mt-2 w-full neo-glass rounded-2xl flex-col p-4 gap-4 md:static md:w-auto md:bg-transparent md:border-none md:p-0 md:flex md:flex-row items-center md:gap-8 text-sm font-semibold tracking-wider">
