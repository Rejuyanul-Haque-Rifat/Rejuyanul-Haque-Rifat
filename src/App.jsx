...
export default function App() {
  ...
  const [profileGrayscale, setProfileGrayscale] = useState(true);
    ...
    <div className="min-h-screen flex flex-col w-full relative">
      ...
      <main className="min-h-screen pt-28 pb-16 px-4 md:px-6 flex items-center relative overflow-hidden" id="home">
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-10 lg:gap-12 items-center w-full mt-6 md:mt-0 relative z-10">
          ...
          <div className="relative flex justify-center items-center gs-reveal order-1 lg:order-2 mb-6 lg:mb-0 mt-4 lg:mt-0">
